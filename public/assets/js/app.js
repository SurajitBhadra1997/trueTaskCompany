...
!function ($) {
    ...
    // var RightContext = function () {
    //     this.body = $('body'),
    //     this.window = $(window)
    // };
    
    // RightContext.prototype.toggleContext = function() {
    //     var self = this;
    //     self.body.toggleClass('right-context-enabled');
    //     self._selectOptionsFromConfig();
    // };

	// toggler by cheery
	// $(document).on('click', '.context-bar-toggle', function () {
