...
export default class boardAddModal extends Component {
  ...
  deleteImage = async ()=>
  {
    ...
    console.log(data);
    let result = await HttpClient.requestData("del-task-img", "POST", data);
  ...
  getTaskList = async () =>
 {
  ...
  if (result && result.status) 
   ...
   description:cur_data[0]&&cur_data[0].task_description!="null"?cur_data[0].task_description:"",
    ...
    return (
      <div>
        ...
        <div
          ...
          id="add1-new-task-modal"
          tabIndex={-1}
          role="dialog"
          aria-labelledby="add1-new-task-modalLabel"
          aria-hidden="true"
        >
          <div className="modal-dialog modal-dialog-centered modal-lg">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title" id="add1-new-task-modalLabel">
                 Edit Task
                </h4>
                <button
                  type="button"
