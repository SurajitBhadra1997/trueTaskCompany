...
export default class index extends Component {
  constructor(props) {
    ...
    this.state = {
      img_url: "http://trutask.easytodb.com/uploads/portfolio_photo/",
      userData: {},
      userId: "",
      // first step
      projectName: "",
  ...
  deletefromStaffing = async (id, index) => {
    ...
    console.log(data);
    let result = await HttpClient.requestData("delete-portstaff", "POST", data);
    console.log(result);
  ...
  deletee = async (id, index) => {
    ...
    console.log("d", d);
    let result = await HttpClient.requestData("delete-portfile", "POST", d);
  ...
  nextStep = async () => {
    if (this.state.activeTab == "basictab1") {
      ...
      if (validation) {
        ...
        let result = await HttpClient.FromAdd("portfoliowizard", "POST", data);
        if (result && result.status) {
          this.setState({
            type: "success",
            status: true,
  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        />
        <Breadcomb pageTitle="Portfolio Wizard" leadTitle="Portfolio" />
        <div className="row">
