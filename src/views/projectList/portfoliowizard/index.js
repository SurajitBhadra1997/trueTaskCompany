...
export default class index extends Component {
  constructor(props) {
    ...
    this.state = {
      img_url:
        "http://trutask.easytodb.com/uploads/portfolio_photo/",
      userData: {},
      userId: "",
      // first step
      projectName: "",
    ...
    optionstask:
      ...
      optionType:[
        ...
        {label:'Waterfall Project Management',value:'Waterfall Project Management'},
        {label:'Scrum Project Management',value:'Scrum Project Management'},
        {label:'Kanban Project Management',value:'Kanban Project Management'},
        {label:'Lean Project Management',value:'Lean Project Management'},
        {label:'Six Sigma Project Management',value:'Six Sigma Project Management'},
      ],
 ...
 selectedCost:"",
  ...
  projectData = async (userId) => {
    ...
    let result = await HttpClient.requestData("portfoliodata", "POST", data);
    ...
    if (result && result.status) {
      ...
      if (this.state.fromId != "") {
        ...
        let holiday_file= currentData[0] && currentData[0].setting[0]?currentData[0].setting[0].holiday : "";
         let temp_arr=currentData[0]&&currentData[0].member?currentData[0].member:null;
        if (currentData.length > 0) {
          this.setState({
            ...
            //setting tab
            country:currentData[0].setting[0]?currentData[0].setting[0].country:"",
            currency:currentData[0].setting[0]?currentData[0].setting[0].currency:"",
            timezone:currentData[0].setting[0]?currentData[0].setting[0].timezone:"",
            frequency:currentData[0].setting[0]?currentData[0].setting[0].frequency:"",
            mileStone:currentData[0].setting[0]?currentData[0].setting[0].milestone:"",
            sprint:currentData[0].setting[0]?currentData[0].setting[0].sprint:"",
            notify:currentData[0].setting[0]?currentData[0].setting[0].notification:"",
            projectstatus:currentData[0].setting[0]?currentData[0].setting[0].project_status:"",
            projecttag:currentData[0].setting[0]?currentData[0].setting[0].project_tags:"",
            projectpriority:currentData[0].setting[0]?currentData[0].setting[0].project_priority:"",
            projectriskcategory:currentData[0].setting[0]?currentData[0].setting[0].project_risk:"",
            taskstatus:currentData[0].setting[0]?currentData[0].setting[0].task_status:"",
            tasktag:currentData[0].setting[0]?currentData[0].setting[0].task_tags:"",
            taskpriority:currentData[0].setting[0]?currentData[0].setting[0].task_priority:"",
            taskriskcategory:currentData[0].setting[0]?currentData[0].setting[0].task_risk:"",

            


            waterfall: currentData[0].project_type,
            project_type:currentData[0].project_type?currentData[0].project_type.split(",")
            : null,
          ...
          temp_arr.forEach((element) => {
            ...
            let dom = {id:element.user_id,label: full_name, value: full_name };
          ...
          if( holiday_file && holiday_file!="")
          {
           ...
           let workweek="";
              workweek=currentData[0].setting[0]?currentData[0].setting[0].work_week:"";
              if( workweek && workweek!="")
              {
                if(workweek.includes('Sunday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
                    sundaySelected:!this.state.sundaySelected
                  });
                }
                if(workweek.includes('Monday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
                    mondaySelected:!this.state.mondaySelected
                  });
                }
                if(workweek.includes('Tuesday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
                   tuesdaySelected:!this.state.tuesdaySelected
                  });
                }
                if(workweek.includes('Wednesday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
                    wednesdaySelected:!this.state.wednesdaySelected
                  });
                }
                if(workweek.includes('Thrusday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
                   thrusdaySelected:!this.state.thrusdaySelected
                  });
                }
                if(workweek.includes('Friday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
                   fridaySelected:!this.state.fridaySelected
                  });
                }
                if(workweek.includes('Saturday'))//include checks whthr the substring is available in the maintream or not
                {
                  this.setState({
             ...
             let proj_status=currentData[0].setting[0]&&currentData[0].setting[0].project_status?currentData[0].setting[0].project_status:"";
             let project_priority=currentData[0].setting[0]&&currentData[0].setting[0].project_priority?currentData[0].setting[0].project_priority:"";
             let proj_tags=currentData[0].setting[0]&&currentData[0].setting[0].project_tags?currentData[0].setting[0].project_tags:"";
             let proj_risk=currentData[0].setting[0]&&currentData[0].setting[0].project_risk?currentData[0].setting[0].project_risk:"";
             let task_status=currentData[0].setting[0]&&currentData[0].setting[0].task_status?currentData[0].setting[0].task_status:"";
             let task_priority=currentData[0].setting[0]&&currentData[0].setting[0].task_priority?currentData[0].setting[0].task_priority:"";
             let task_tags=currentData[0].setting[0]&&currentData[0].setting[0].task_tags?currentData[0].setting[0].task_tags:"";
             let task_risk=currentData[0].setting[0]&&currentData[0].setting[0].task_risk?currentData[0].setting[0].task_risk:"";
         ...
         let cat_name=currentData[0].setting[0]?currentData[0].setting[0].category:"";
         if(cat_name&&cat_name!="")
                {
                this.categoryfromApi(cat_name);
                }
             //report from api in settings tab 
             let report=currentData[0].setting[0]?currentData[0].setting[0].report:"";
                 this.setState({
                   report:report
                 });
          ...
          if(this.state.report!=""&&staff_get.length>0)//to send the report name from settings tab to communication tab
          {
          ...
          let costex_get = currentData[0].external_get?currentData[0].external_get:[];
...
generateArrayList=(async)=>
{
  let data={};
    ...
    this.state.obj1= this.state.selectedworkingday.reduce((acc,current,i)=>{
      acc[i] = current;
      return acc;
  }, {});
...
deletefromStaffing = async (id,index) =>
{
  ...
  console.log(data);
    let result = await HttpClient.requestData("delete-staff", "POST",data);
    console.log(result);
...

{
  if(imgfile && imgfile !='')
  {
    if(imgfile.includes('jpg')||imgfile.includes('jpeg')||imgfile.includes('webp'))
    {
        this.setState({
          holiday_new_img:[
            {
    ...
    else if(imgfile.includes('pdf'))
    {
      ...
      this.setState({
        holiday_new_img:[
          {
            preview:"https://cdn3.iconfinder.com/data/icons/line-icons-set/128/1-02-512.png",
            type:"pdf"
        }]
      });
    }
    else if(imgfile.includes('doc')||imgfile.includes('docx'))
    {
      ...
      this.setState({
        holiday_new_img:[
          {
            preview:"https://www.kindpng.com/picc/m/249-2499221_download-icon-document-download-icon-png-transparent-png.png",
            type:"doc"
        }]
      });
    }
 ...
 //2
  ...
  onDelete3 (i) {
    ...
    this.setState({ tags2:this.state.tags3 });
  }
            ...
            if(this.state.tags2 == "")
            {
              ...
              if(this.state.tags3== "")
              {
                ...
                if(this.state.sprint== "")
                {
                  ...
                  {
                    this.setState({ errMsg: "Please Select projecttype field" });
                    return false;
                  }else{
                    if(this.state.tags4== "")
                    {
                      this.setState({ errMsg: "Please Select project task status" });
                      return false;
                    }else{
                      if(this.state.tags5== "")
                      {
                        this.setState({ errMsg: "Please Select project task priority" });
                        return false;
                      }else{
                        if(this.state.tags6== "")
                        {
                          this.setState({ errMsg: "Please Select project task tag" });
                          return false;
                        }else{
                          if(this.state.tags7== "")
                          {
                            this.setState({ errMsg: "Please Enter project task riskcategory" });
                            return false;
                          }else{
                            if(this.state.holiday_new_img.length==0)
                            {
                              this.setState({ errMsg: "Please select one file" });
                              return false;
                            }else{
                              if(this.state.cat=="")
                            {
                              this.setState({ errMsg: "Please select category" });
                              return false;
                            }else{
                              if(this.state.report=="")
                            {
                              this.setState({ errMsg: "Please enter report" });
                              return false;
                            }else{
                             
                              if(this.state.notify== "")
                              {
                                this.setState({ errMsg: "Please Select notification" });
                                return false;
                              }else{
                                if(this.state.frequency== "")
                                {
                                  this.setState({ errMsg: "Please Enter frequency" });
                                  return false;
                                }else{
                                         return true;
                                }
  ...
  nextStep = async () => {
    ...
    console.log(projecttypeselect);
      ...
      this.generateArrayList();
       ...
       data.append("milestone",this.state.mileStone);
                  ...
                  <ul className="nav nav-pills nav-justified form-wizard-header mb-4">
                    ...
                    <li className="nav-item">
                      ...
                      >
                        ...
                        <span className="d-none d-sm-inline">Gantt Chart</span>
                      </a>
                    </li>
                    {/* <li className="nav-item">
                      <a
                          ...
                          <div className="form-group row mb-3">
                            ...
                            <select 
                               ...
                               disabled
                                  ...
                                  {this.state.optionscountry.map(function(data, key){  return (
                          ...
                          <div className="form-group row mb-3">
                            ...
                            <select 
                               ...
                               disabled
                                  ...
                                  {this.state.optionssprint.map(function(data, key){  return (
                               <option key={key} value={data.value}>{data.value} </option> )
                                         })}
                            ...
                            /> */}
                             ...
                             isDisabled
                                ...
                                onInput={query => {
                                     ...
                                     let dom={
                                     id:this.state.category.length+1,name:query
                                    };
                                    console.log(dom);
                          ...
                          <div className="form-group row mb-3">
                            ...
                            <select 
                               ...
                               disabled
                                  ...
                                  {this.state.notificationtype.map(function(data, key){  return (
                               <option key={key} value={data.value}>{data.value} </option> )
                                         })}
                                    ...
                                    {index == 0 ? null : (
                                      <button
                                        ...
                                        onClick={() => {
                                         ...
                                         {
                                       this.deletefromStaffing(item.id,index)
                                         }
                                        }
                                                     }}
                              ...
                              return (
                                ...
                                // onChange={this.handleChange}
                                 onChange={(checked) => { 
                                  ...
                                  checked={item.responsible=="1"?true:false}//checked is maintaing the current position of the switch(checked is in green position or in disabled position)
                                 id="normal-switch"
                                     />
                                  </td>
                                  <td>
                                 ...
                                 onChange={(checked) => {
                                  ...
                                  checked={item.consultant=="1"?true:false}
                                 id="normal-switch"
                                     />
                                  </td>
                                  <td>
                                 ...
                                 onChange={(checked) => {
                                  ...
                                  checked={item.inquire=="1"?true:false}
                                 id="normal-switch"
                                     />
                                  </td>
                                  <td>
                                ...
                                onChange={(checked) => {
                                 ...
                                 checked={item.accountable=="1"?true:false}
                                id="normal-switch"
                                    />
                                  </td>
                                  <td>
                            ...
                            {this.state.cost.map((item, index) => {
                              return (
                               ...
                               <option key={key} value={data.value}>{data.value} </option> )
                                  ...
                                  <td>
                                    ...
                                    disabled
                                      ...
                                      // placeholder="Brinkman"
                                      value={
                                        this.state.cost[index]
                                          .resource
                                      }
                                      onChange={(val) => {
                                        this.state.cost[
                                          index
                                        ].resource = val.target.value;
                                        this.setState({});
                                      }}
                                    />
                                  </td>
                               ...
                               value={item.expense}
                                  ...
                                  {this.state.seletedTeam.map(function(data, key){  return (
                               <option key={key} value={data.value}>{data.value} </option> )
                                         })}
                                        ...
                                        {this.state.procurement.map(
                                          (item, index) => {
                                            ...
                                            if (ext == "pdf") {
                                              ...
                                              let pdfUrl = this.state.img_url + item.image;
                                              // console.log(pdfUrl);
                                              return (
                                                <>
                                                  <a
                            ...
                            <div className="d-block" id="uploadPreviewTemplate">
                              <div className="card mt-1 mb-0 shadow-none border">
                                <div className="p-2">
                                  ...
                                  <div className="row align-items-center">
                                    {/* cheery's lightbox & pdf design */}
                                    {this.state.risk_image_array.length > 0 ? (
                                      <Lightbox
                                        ...
                                        {this.state.riskImage.map(
                                          (item, index) => {
                                            ...
                                            if (ext == "pdf") {
                                              ...
                                              // this.state.riskImage.pop(index);
                                              //       this.setState({});
                                                       this.riskdeletee(item.id,index)
                                                           }}
                                                            >
                                    <i className="dripicons-cross" />
                                             </a>
                            ...
                            <div className="d-block" id="uploadPreviewTemplate">
                              <div className="card mt-1 mb-0 shadow-none border">
                                <div className="p-2">
                                  ...
                                  <div className="row align-items-center">
                                    {/* cheery's lightbox & pdf design */}
                                    {this.state.govr_image_array.length > 0 ? (
                                      <Lightbox
                                        ...
                                        {this.state.governance.map(
                                          (item, index) => {
                                            ...
                                            if (ext == "pdf") {
                                              ...
                                              // this.state.riskImage.pop(index);
                                              //       this.setState({});
                                                this.governdeletee(item.id,index);
                                                           }}
                                                            >
                                                <i className="dripicons-cross" />
                                             </a>
