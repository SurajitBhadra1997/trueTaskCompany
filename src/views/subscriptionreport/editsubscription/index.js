          ...
          <div className="container-fluid">
            <div className="page-title-box">
              <Row className="align-items-center">
                <Col sm="6">
                  <h4 className="page-title">Edit Subscription Plans</h4>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">Edit Subscription Plans</li>
                  </ol>
                </Col>
                <Col sm="6">
            ...
            <Row>
              <Col>
                <Card>
                  <CardBody>
                    <h4 className="mt-0 header-title">Edit Subscription Plans</h4>
                    {this.state.alert ? (
                      <Alert
                        color="success"
